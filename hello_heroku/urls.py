...
urlpatterns = [
    ...
    url(r'^accounts/login/$', LoginView.as_view(), name='login_view'),     # https://docs.djangoproject.com/en/1.9/topics/auth/default/#how-to-log-a-user-in
    url(r'^logout/$', LogoutView.as_view(), {'next_page': 'index_view'}, name='logout_view'),
